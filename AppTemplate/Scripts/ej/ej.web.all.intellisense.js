...
intellisense.annotate(ej.Schedule.prototype, {
	...
	'searchAppointments' : function (searchString, field, operator, ignorAppTemplatee){
		///<signature>
			...
			///<param name='ignorAppTemplatee' type='boolean' optional='false' >Defines the ignorAppTemplatee value for performing the search operation.</param>
			///<returns type ='Syncfusion' />
		///</signature>
	},
	'refresh' : function(){
