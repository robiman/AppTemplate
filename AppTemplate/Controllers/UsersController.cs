...
namespace AppTemplate.Controllers
{
    ...
    {/*
        ...
        public ActionResult Login(Users users)
        {
            ...
            {
                var user = db.User.Where(ur=> ur.UserName.Equals(users.UserName) && ur.Password.Equals(users.Password)).ToList();
                if (user.Count() > 0)
                {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "UserName,Password")] Users users)
        {
            if (ModelState.IsValid)
            {
