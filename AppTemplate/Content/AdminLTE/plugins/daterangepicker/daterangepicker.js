                ...
                '<div class="ranges">' +
                  '<div class="range_inputs">' +
                        ...
                        '</div>' +
                            ...
                            '<button class="applyBtn"  type="submit" name="apply"  value="apply" "></button> ' +
                            '<button class="cancelBtn" type="submit" name="apply"  value="cancel" ></button>' +                       
                     
                  '</div>' +
                '</div>' +
              '</div>';
        //<noscript><input type="submit" value="Submit"></noscript>
        //onchange="this.form.submit() '<form action="#" method="post" name="apply">' + '</form>' +
        //custom options
        ...
        setOptions: function(options, callback) {
            ...
            if (typeof options.ranges === 'object') {
                ...
                for (range in this.ranges) {
                    list += '<form><li><button type="submit" name="daterange" value="' + range + '">' + range + '</li></form>';
                }
